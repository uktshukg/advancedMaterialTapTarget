...
package com.dexter.advancedmaterialtaptarget.extras;
...
public class PromptOptions<T extends PromptOptions>
{
    ...
    private boolean isPromptBackgroundClickable;
    ...
    @NotNull
    public T setPromptBackgroundClickable(boolean isClickable) {
        isPromptBackgroundClickable = isClickable;
        return (T) this;
    }
}
